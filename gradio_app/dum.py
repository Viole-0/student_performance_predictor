...
# ============================================================
    ...
    st.markdown("""
This project, **Predictive Analytics for Student Performance**, uses machine learning
...
""")
    ...
    st.markdown("""
**Developed by:**
- V (B.Tech CSE, 3rd Year)  
- *[Add Teammate Name]*  

**Contributions (example):**
- V: Data preprocessing, model training & evaluation, Streamlit app development.  
- Teammate: Exploratory data analysis, documentation, result interpretation.  
""")
